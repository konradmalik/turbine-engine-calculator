...
% Last Modified by GUIDE v2.5 11-Jun-2015 10:46:35
...
% --- Executes on button press in singlepoint_button.
function singlepoint_button_Callback(hObject, eventdata, handles)
% hObject    handle to singlepoint_button (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
