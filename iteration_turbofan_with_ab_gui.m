function varargout = iteration_turbofan_with_ab_gui(varargin)
% iteration_turbofan_with_ab_gui MATLAB code for iteration_turbofan_with_ab_gui.fig
%      iteration_turbofan_with_ab_gui, by itself, creates a new iteration_turbofan_with_ab_gui or raises the existing
%      singleton*.
%
%      H = iteration_turbofan_with_ab_gui returns the handle to a new iteration_turbofan_with_ab_gui or the handle to
%      the existing singleton*.
%
%      iteration_turbofan_with_ab_gui('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in iteration_turbofan_with_ab_gui.M with the given input arguments.
%
%      iteration_turbofan_with_ab_gui('Property','Value',...) creates a new iteration_turbofan_with_ab_gui or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before iteration_turbofan_with_ab_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to iteration_turbofan_with_ab_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help iteration_turbofan_with_ab_gui

% Last Modified by GUIDE v2.5 25-Jun-2015 20:48:32

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @iteration_turbofan_with_ab_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @iteration_turbofan_with_ab_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before iteration_turbofan_with_ab_gui is made visible.
function iteration_turbofan_with_ab_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to iteration_turbofan_with_ab_gui (see VARARGIN)

% Choose default command line output for iteration_turbofan_with_ab_gui
...
% UIWAIT makes iteration_turbofan_with_ab_gui wait for user response (see UIRESUME)
% uiwait(handles.iteration_turbofan_with_ab_gui);


% --- Outputs from this function are returned to the command line.
function varargout = iteration_turbofan_with_ab_gui_OutputFcn(hObject, eventdata, handles) 
...
while height<handles.height_end+handles.height_step
    while mach<handles.mach_end+handles.mach_step
        [parameters, nozzle_int, out_int, out_ext, out_int_plot, mdot_f, mdot_fAB, alpha, alpha_AB, lf, lHPT, lHPC, lLPT, lLPC, f, kj, Tr, bj, etat, etap, eta ] = turbofan_with_ab(handles.level, handles.Wu, handles.inlet, handles.turbine, handles.nozzle, height, mach, handles.mdot0, handles.M1, handles.M2, handles.M3i2, handles.M5, handles.M7, handles.BR, handles.piF, handles.piC, handles.FtoLPC, handles.temperature, handles.temperature7, handles.vc, handles.cool1, handles.cool2);
...
close(iteration_turbofan_with_ab_gui)
run('iteration_postproc_with_ab');
...
% --- Executes on key press with focus on iteration_turbofan_with_ab_gui or any of its controls.
function iteration_turbofan_no_AB_gui_WindowKeyPressFcn(hObject, eventdata, handles)
% hObject    handle to iteration_turbofan_with_ab_gui (see GCBO)
