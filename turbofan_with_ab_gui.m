function varargout = turbofan_with_ab_gui(varargin)
% turbofan_with_ab_gui MATLAB code for turbofan_with_ab_gui.fig
%      turbofan_with_ab_gui, by itself, creates a new turbofan_with_ab_gui or raises the existing
%      singleton*.
%
%      H = turbofan_with_ab_gui returns the handle to a new turbofan_with_ab_gui or the handle to
%      the existing singleton*.
%
%      turbofan_with_ab_gui('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in turbofan_with_ab_gui.M with the given input arguments.
%
%      turbofan_with_ab_gui('Property','Value',...) creates a new turbofan_with_ab_gui or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before turbofan_with_ab_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to turbofan_with_ab_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help turbofan_with_ab_gui

% Last Modified by GUIDE v2.5 13-Jun-2015 22:20:36

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @turbofan_with_ab_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @turbofan_with_ab_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before turbofan_with_ab_gui is made visible.
function turbofan_with_ab_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to turbofan_with_ab_gui (see VARARGIN)

% Choose default command line output for turbofan_with_ab_gui
...
% UIWAIT makes turbofan_with_ab_gui wait for user response (see UIRESUME)
% uiwait(handles.turbofan_with_ab_gui);


% --- Outputs from this function are returned to the command line.
function varargout = turbofan_with_ab_gui_OutputFcn(hObject, eventdata, handles) 
...
[parameters, nozzle_int, out_int, out_ext, out_int_plot, mdot_f, mdot_fAB, alpha, alpha_AB, lf, lHPT, lHPC, lLPT, lLPC, f, kj, Tr, bj, etat, etap, eta ] = turbofan_with_ab(handles.level, handles.Wu, handles.inlet, handles.turbine, handles.nozzle, handles.height, handles.M0, handles.mdot0, handles.M1, handles.M2, handles.M3i2, handles.M5, handles.M7, handles.BR, handles.piF, handles.piC, handles.FtoLPC, handles.temperature, handles.temperature7, handles.vc, handles.cool1, handles.cool2);
...
assignin('base', 'mdot_f', mdot_fAB);
assignin('base', 'alpha', alpha);
assignin('base', 'alpha', alpha_AB);
assignin('base', 'lf', lf);
...
if isreal(out_int)
    close(turbofan_with_ab_gui)
    run('postproc_with_ab')
else
