function varargout = iteration_altitude_turbofan_no_ab_gui(varargin)
% ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI MATLAB code for iteration_altitude_turbofan_no_ab_gui.fig
%      ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI, by itself, creates a new ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI or raises the existing
%      singleton*.
%
%      H = ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI returns the handle to a new ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI or the handle to
%      the existing singleton*.
%
%      ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI.M with the given input arguments.
%
%      ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI('Property','Value',...) creates a new ITERATION_ALTITUDE_TURBOFAN_NO_AB_GUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before iteration_altitude_turbofan_no_ab_gui_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to iteration_altitude_turbofan_no_ab_gui_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help iteration_altitude_turbofan_no_ab_gui

% Last Modified by GUIDE v2.5 13-Jun-2015 22:21:41

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @iteration_altitude_turbofan_no_ab_gui_OpeningFcn, ...
                   'gui_OutputFcn',  @iteration_altitude_turbofan_no_ab_gui_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before iteration_altitude_turbofan_no_ab_gui is made visible.
function iteration_altitude_turbofan_no_ab_gui_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to iteration_altitude_turbofan_no_ab_gui (see VARARGIN)

% Choose default command line output for iteration_altitude_turbofan_no_ab_gui
...
% UIWAIT makes iteration_altitude_turbofan_no_ab_gui wait for user response (see UIRESUME)
% uiwait(handles.iteration_altitude_turbofan_no_ab_gui);


% --- Outputs from this function are returned to the command line.
function varargout = iteration_altitude_turbofan_no_ab_gui_OutputFcn(hObject, eventdata, handles) 
...
while height<handles.end+handles.step
    [parameters, nozzle_int, nozzle_ext, out_int, out_ext, out_int_plot, mdot_f, alpha, lf, lHPT, lHPC, lLPT, lLPC, f, kjint, kjext, kj, Tr, bj, etat, etap, eta ] = turbofan_no_ab(handles.level, handles.Wu, handles.inlet, handles.turbine, handles.nozzle, height, handles.M0, handles.mdot0, handles.M1, handles.M2, handles.M3i2, handles.M5, handles.BR, handles.piF, handles.piC, handles.FtoLPC, handles.temperature, handles.vc, handles.cool1, handles.cool2);
...
close(iteration_altitude_turbofan_no_ab_gui)
run('iteration_altitude_postproc_no_ab');
