...
elseif default == 2
    ...
    M7 = input('Enter the mach number in section 7: ');
else
    error('You must type "1" or "2"');
end
...
temperature_ab = input('Enter "1" for a custom value of Tt7 or anything else for default based on the engine level: ');
if temperature_ab == 1
    Tt7 = input('Enter the Tt7: ');
else
    Tt7 = parameters(11);
end
...
%section 6
[ out_int(13,:) ] = section_6( out_int(12,:), out_ext(4,:), parameters, BR );
out_int_plot(11,:) = out_int(13,:);
[out_ext(5,:)] = out_int(13,:);

%section 7
[ out_int(14,:), mdot_fAB, fAB, alpha_AB ] = section_7( out_int(13,:), parameters, Wu, Tt7, M7 );
out_int_plot(12,:) = out_int(14,:);
[out_ext(6,:)] = out_int(14,:);

%section 9
[out_int(15,:), nozzle_int] = section_9(out_int(14,:), parameters, p0);
out_int_plot(13,:) = out_int(15,:);
[out_ext(7,:)] = out_int(15,:);
...
R = out_int(1,4);
V0 = M0 * sqrt(k * R * T0);
[ kjint, kjext, kj, Tr, bj, etat, etap, eta ] = engine_parameters_bypass_turbofan_AB( out_int(13,7), out_ext(5,7), p0,out_int(13,8), out_ext(5,8), out_int(13,10), out_ext(5,10), V0, out_int(13,4), out_ext(5,4), BR, f, fAB, mdot0, Wu );